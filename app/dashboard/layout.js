...
const NAV_ITEMS = [
    ...
    { href: '/dashboard/analytics', label: 'Analytics', icon: IoBarChartOutline, activeIcon: IoBarChart },
    { href: '/dashboard/pos', label: 'POS', icon: IoCartOutline, activeIcon: IoCart },
    { href: '/dashboard/products', label: 'Products', icon: IoCubeOutline, activeIcon: IoCube },
    { href: '/dashboard/vouchers', label: 'Vouchers', icon: IoTicketOutline, activeIcon: IoTicket },
    { href: '/dashboard/transactions', label: 'History', icon: IoReceiptOutline, activeIcon: IoReceipt },
];
        ...
        <div className={styles.layout}>
            ...
            <aside className={styles.sidebar}>
                <div className={styles.sidebarHeader}>
                    ...
                    <div>
                        <div className={styles.sidebarBrand}>RoomCollection</div>
